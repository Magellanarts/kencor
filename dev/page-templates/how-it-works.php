...
<section class="l-content-container u-hide@med">
  <div class="l-content-container__block l-content-container__block--intro">
    ...
    <div class="c-page-intro">
      <p>SAMiConnect integrates with the latest AI
        technology to keep your patients engaged
        in their treatment plan while keeping your
        team connected to how they are doing.
        SAMi takes on the heavy lifting of gathering,
        interpreting, and reporting critical patient
        data collected from all connected devices.
        SAMi then processes and presents the data
        in a simple dashboard so your care team can
        take action.</p>
    </div>
  </div>
  ...
  <div class="l-content-container__block l-content-container__block--no-padding u-hide@med">
    ...
    <div class="l-section--newsroom u-gradient--orange is-active js-toggle-section js-hiw-intro" data-section="intro">
      <div class=" u-white-text">
        <div class="c-hiw-intro-graphic">
          ...
          <div class="c-hiw-intro-graphic__circle js-hiw-intro-graphic__circle" data-size="small"></div>

          <div class="c-hiw-intro-graphic__step c-hiw-intro-graphic__step--1 js-hiw-intro-graphic__step animated" data-size="small">
          ...
          <div class="c-hiw-intro-graphic__step c-hiw-intro-graphic__step--2 js-hiw-intro-graphic__step animated"  data-size="small">
          ...
          <div class="c-hiw-intro-graphic__step c-hiw-intro-graphic__step--3 js-hiw-intro-graphic__step animated"  data-size="small">
          ...
          <div class="c-hiw-intro-graphic__step c-hiw-intro-graphic__step--4 js-hiw-intro-graphic__step animated"  data-size="small">
    ...
    <div class="l-section--newsroom u-gradient--8 js-toggle-section" data-section="sami-goes-home">
      <div class=" u-white-text">
        ...
        <div class="c-home-tools">
          <img src="<?php echo get_template_directory_uri(); ?>/i/hiw/step2/Step2_phone.svg">

          <img src="<?php echo get_template_directory_uri(); ?>/i/hiw/step2/Step2_scale.svg">

          <img src="<?php echo get_template_directory_uri(); ?>/i/hiw/step2/Step2_BP.svg">
        </div>
    ...
    <div class="l-section--newsroom u-gradient--9 js-toggle-section" data-section="sami-on-task">
      <div class=" u-white-text">
        ...
        <video class="c-hiw-step-graphic c-hiw-step-graphic--shadow--1 js-video-player" data-index="4" data-size="small" >
...
<style>.BhaMyAcU_0{stroke-dasharray:1524 1526;stroke-dashoffset:1525;}.start .BhaMyAcU_0{animation:BhaMyAcU_draw 4000ms linear 0ms forwards;}@keyframes BhaMyAcU_draw{100%{stroke-dashoffset:0;}}@keyframes BhaMyAcU_fade{0%{stroke-opacity:1;}94.44444444444444%{stroke-opacity:1;}100%{stroke-opacity:0;}}</style></svg>
    ...
    <div class="l-section--newsroom u-gradient--13 js-toggle-section" data-section="sami-high-risk-patients">
      <div class=" u-white-text">
        ...
        <video class="c-hiw-step-graphic c-hiw-step-graphic--shadow--2 js-video-player" data-index="8" data-size="small" >
    ...
    <div class="l-section--newsroom u-gradient--4 js-toggle-section" data-section="sami-empowers-team">
      <div class=" u-white-text">
        <video class="c-hiw-step-graphic c-hiw-step-graphic--shadow--3 js-video-player" data-index="9" data-size="small" >
    ...
    <div class="l-section--newsroom u-gradient--15 js-toggle-section" data-section="sami-integrations">
      <div class=" u-white-text">
        ...
        <div class="c-hiw-step-graphic c-integrations-animation js-integrations-animation">
...
<div id="fullpage" class="u-show@med" >
  <div class="section">
    <section class="l-content-container">
      <div class="l-content-container__block l-content-container__block--intro">
        <div  class="hide-me animated js-intro--1" data-size="big">
          <header class="c-page-header">
            <h1>How<br> <span class="u-blue-text">it</span> works</h1>
          </header>
      ...
      <div class="l-content-container__block l-content-container__block--no-padding">
        <div class="l-section--newsroom u-gradient--orange is-active js-toggle-section" data-section="intro">
          ...
          <div class=" u-white-text">
            ...
            <div class="c-hiw-intro-graphic">
              <img class="c-hiw-intro-graphic__placeholder" src="<?php echo get_template_directory_uri(); ?>/i/hiw/animations/intro/hiw-intro-placeholder.jpg">
              <div class="c-hiw-intro-graphic__circle js-hiw-intro-graphic__circle" data-size="big"></div>

              <div class="c-hiw-intro-graphic__step c-hiw-intro-graphic__step--1 js-hiw-intro-graphic__step animated"  data-size="big">
                <img src="<?php echo get_template_directory_uri(); ?>/i/hiw/animations/intro/Intro_SAMi_icon.svg" class="c-hiw-intro-graphic__step__icon">
                <div class="c-hiw-intro-graphic__step__label">Conversational Bot</div>
              </div>


              <div class="c-hiw-intro-graphic__step c-hiw-intro-graphic__step--2 js-hiw-intro-graphic__step animated"  data-size="big">
                <img src="<?php echo get_template_directory_uri(); ?>/i/hiw/animations/intro/Intro_IVR_icon.svg" class="c-hiw-intro-graphic__step__icon">
                <div class="c-hiw-intro-graphic__step__label">Phone / IVR</div>
              </div>

              <div class="c-hiw-intro-graphic__step c-hiw-intro-graphic__step--3 js-hiw-intro-graphic__step animated"  data-size="big">
                <img src="<?php echo get_template_directory_uri(); ?>/i/hiw/animations/intro/Intro_Alexa_icon.svg" class="c-hiw-intro-graphic__step__icon">
                <div class="c-hiw-intro-graphic__step__label">Voice AI<br>Alexa, Google Home</div>
              </div>

              <div class="c-hiw-intro-graphic__step c-hiw-intro-graphic__step--4 js-hiw-intro-graphic__step animated"  data-size="big">
                <img src="<?php echo get_template_directory_uri(); ?>/i/hiw/animations/intro/Intro_Computer_icon.svg" class="c-hiw-intro-graphic__step__icon">
                <div class="c-hiw-intro-graphic__step__label">Traditional<br> patient portals</div>
              </div>
  ...
  <div class="section">
    <section class="l-content-container">
      <div class="l-content-container__block l-content-container__block--intro">
        <div class="hide-me animated js-intro--2"  data-size="big">
          <header class="c-page-header">
            <h1>Develop a<br> <span class="u-blue-text">treatment</span><br> plan</h1>
          </header>
  ...
  <div class="section">
    <section class="l-content-container">
      <div class="l-content-container__block l-content-container__block--intro">
        <div class="hide-me animated js-intro--3"  data-size="big">
          <header class="c-page-header">
            <h1>SAMi goes<br> <span class="u-blue-text">home</span></h1>
          </header>
  ...
  <div class="section">
    <section class="l-content-container">
      <div class="l-content-container__block l-content-container__block--intro">
        <div class="hide-me animated js-intro--4"  data-size="big">
          <header class="c-page-header">
            <h1>SAMi keeps<br> <span class="u-blue-text">your patient</span> on task</h1>
          </header>
      ...
      <div class="l-content-container__block l-content-container__block--no-padding">
        <div class="l-section--newsroom u-gradient--9 js-toggle-section" data-section="sami-on-task">
          <div class=" u-white-text">
            ...
            <video class="c-hiw-step-graphic c-hiw-step-graphic--shadow--1 js-video-player" data-index="4" data-size="big" >
              <source src="<?php echo get_template_directory_uri(); ?>/i/hiw/Kencor_HowItWorks_step3.mp4" type="video/mp4">
            </video>
  ...
  <div class="section">
    <section class="l-content-container">
      <div class="l-content-container__block l-content-container__block--intro">
        <div class="hide-me animated js-intro--5"  data-size="big">
          <header class="c-page-header">
            <h1>SAMi keeps<br> <span class="u-blue-text">loved ones</span> connected</h1>
          </header>
  ...
  <div class="section">
    <section class="l-content-container">
      <div class="l-content-container__block l-content-container__block--intro">
        <div class="hide-me animated js-intro--6"  data-size="big">
          <header class="c-page-header">
            <h1>SAMi analyzes<br> critical <span class="u-blue-text">information</span></h1>
          </header>
...
<style>.BhaMyAcU_0{stroke-dasharray:1524 1526;stroke-dashoffset:1525;}.start .BhaMyAcU_0{animation:BhaMyAcU_draw 3000ms linear 0ms forwards;}@keyframes BhaMyAcU_draw{100%{stroke-dashoffset:0;}}@keyframes BhaMyAcU_fade{0%{stroke-opacity:1;}94.44444444444444%{stroke-opacity:1;}100%{stroke-opacity:0;}}</style></svg>
  ...
  <div class="section">
    <section class="l-content-container">
      <div class="l-content-container__block l-content-container__block--intro">
        <div class="hide-me animated js-intro--7"  data-size="big">
          <header class="c-page-header">
            <h1>SAMi tracks<br> <span class="u-blue-text">your patient</span></h1>
          </header>
  ...
  <div class="section">
    <section class="l-content-container">
      <div class="l-content-container__block l-content-container__block--intro">
        <div class="hide-me animated js-intro--8"  data-size="big">
          <header class="c-page-header">
            <h1>SAMi screens<br> high risk <span class="u-blue-text">patients</span></h1>
          </header>
      ...
      <div class="l-content-container__block l-content-container__block--no-padding">
        <div class="l-section--newsroom u-gradient--13 js-toggle-section" data-section="sami-high-risk-patients">
          <div class=" u-white-text">
            ...
            <video class="c-hiw-step-graphic c-hiw-step-graphic--shadow--2 js-video-player" data-index="8" data-size="big" >
              <source src="<?php echo get_template_directory_uri(); ?>/i/hiw/Kencor_HowItWorks_step7.mp4" type="video/mp4">
            </video>
  ...
  <div class="section">
    <section class="l-content-container">
      <div class="l-content-container__block l-content-container__block--intro">
        <div class="hide-me animated js-intro--9"  data-size="big">
          <header class="c-page-header">
            <h1>SAMi <span class="u-blue-text">empowers</span> your team</h1>
          </header>
      ...
      <div class="l-content-container__block l-content-container__block--no-padding">
        <div class="l-section--newsroom u-gradient--4 js-toggle-section" data-section="sami-empowers-team">
          <div class=" u-white-text">
            ...
            <video class="c-hiw-step-graphic c-hiw-step-graphic--shadow--3 js-video-player" data-index="9" data-size="big">
              <source src="<?php echo get_template_directory_uri(); ?>/i/hiw/Kencor_HowItWorks_step8.mp4" type="video/mp4">
            </video>
          </div>
          <div class="c-scroll-next-btn-container u-text-align-center">
  ...
  <div class="section">
    <section class="l-content-container">
      <div class="l-content-container__block l-content-container__block--intro">
        <div class="hide-me animated js-intro--10"  data-size="big">
          <header class="c-page-header">
            <h1>SAMi, your patient's very own care <span class="u-blue-text">companion</span></h1>
          </header>
  ...
  <div class="section">
    <section class="l-content-container">
      <div class="l-content-container__block l-content-container__block--intro">
        <div class="hide-me animated js-intro--11"  data-size="big">
          <header class="c-page-header">
            <h1>SAMi integrations <span class="u-blue-text">create efficiencies</span></h1>
          </header>
